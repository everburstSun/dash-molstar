...
class Atom(object):
    def __init__(self, number: int = None, name: str = None, x: float = None, y: float = None, z: float = None):
        self.__name = name
        ...
        self.__valid = self.__number is not None
...
class Residue(object):
    ...
    def __parse_data(self, atoms: List['Atom']):
        if atoms:
            for atom in atoms:
                ...
                y = atom.get('y')
                z = atom.get('z')
                self.add_atom(number, name, x, y, z)
    ...
    def add_atom(self, number: int, name: str = None, x: float = None, y: float = None, z: float = None):
        atom = Atom(number, name, x, y, z)
...
if __name__ == "__main__":
    sample_data = {'chains': [{'name': 'L', 'auth_name': 'L', 'residues': [{'name': 'GLY', 'index': 62, 'number': 62, 'ins_code': '', 'atoms': [{'name': 'N', 'number': 4817, 'x': 3.759000062942505, 'y': -11.343000411987305, 'z': -5.960999965667725}, {'name': 'CA', 'number': 4818, 'x': 4.876999855041504, 'y': -12.213000297546387, 'z': -6.27400016784668}, {'name': 'C', 'number': 4819, 'x': 6.201000213623047, 'y': -11.520999908447266, 'z': -6.026000022888184}, {'name': 'O', 'number': 4820, 'x': 6.288000106811523, 'y': -10.29699993133545, 'z': -6.059000015258789}]}, {'name': 'ASN', 'index': 133, 'number': 133, 'ins_code': '', 'atoms': [{'name': 'N', 'number': 5366, 'x': -15.53499984741211, 'y': -41.314998626708984, 'z': 11.765999794006348}, {'name': 'CA', 'number': 5367, 'x': -16.469999313354492, 'y': -40.20199966430664, 'z': 11.64799976348877}, {'name': 'C', 'number': 5368, 'x': -16.136999130249023, 'y': -38.9630012512207, 'z': 12.482000350952148}, {'name': 'O', 'number': 5369, 'x': -15.72700023651123, 'y': -39.069000244140625, 'z': 13.640000343322754}, {'name': 'CB', 'number': 5370, 'x': -17.892000198364258, 'y': -40.66999816894531, 'z': 11.961000442504883}, {'name': 'CG', 'number': 5371, 'x': -18.92799949645996, 'y': -39.95800018310547, 'z': 11.12399959564209}, {'name': 'OD1', 'number': 5372, 'x': -18.735000610351562, 'y': -39.75400161743164, 'z': 9.925000190734863}, {'name': 'ND2', 'number': 5373, 'x': -20.030000686645508, 'y': -39.5620002746582, 'z': 11.75100040435791}]}]}, {'name': 'H', 'auth_name': 'H', 'residues': [{'name': 'ARG', 'index': 105, 'number': 99, 'ins_code': 'B', 'atoms': [{'name': 'N', 'number': 825, 'x': 1.0479999780654907, 'y': -5.711999893188477, 'z': -34.37200164794922}, {'name': 'CA', 'number': 826, 'x': 2.497999