...
- style (dict; optional):
    ...
    _type = 'MolstarViewer'
    @_explicitize_args
    def __init__(self, id=Component.UNDEFINED, style=Component.UNDEFINED, className=Component.UNDEFINED, data=Component.UNDEFINED, layout=Component.UNDEFINED, selection=Component.UNDEFINED, focus=Component.UNDEFINED, autoFocus=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'autoFocus', 'className', 'data', 'focus', 'layout', 'selection', 'style']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'autoFocus', 'className', 'data', 'focus', 'layout', 'selection', 'style']
